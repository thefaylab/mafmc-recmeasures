...
#CV 
CV <- (sd(gamfit$fit))/(mean(gamfit$fit))*100
...
#from randomly trying a few different starting regulations, upperCI_test/outputland varies from ~1.2 - ~1.55, lowerCI_test/outputland varies from ~0.4 - ~0.75. CV varies from 195 - 244
```
...
#3.2
if(RHL < lowerCI & BBMSY >= 1 & BBMSY < 1.5){x <- abs((RHL-expectedharvest)/expectedharvest); if(x > 0.2){x <- 0.2}} 
  
#3.3
if(RHL < lowerCI & BBMSY < 1){x <- abs((RHL-expectedharvest)/expectedharvest); if(x > 0.4){x <- 0.4}} 
...
if(BBMSY >= 1.5 & Overfishing == "no" & Bpresent > Bpast & Rpresent > Rpast){x <- liberal}
if(BBMSY >= 1.5 & Overfishing == "no" & Bpresent > Bpast & Rpresent < Rpast){x <- liberal}
if(BBMSY >= 1.5 & Overfishing == "no" & Bpresent < Bpast & Rpresent > Rpast){x <- initial}
if(BBMSY >= 1.5 & Overfishing == "no" & Bpresent < Bpast & Rpresent < Rpast){x <- initial}

    #Overfishing is occurring
#RHL not exceeded
if(BBMSY >= 1.5 & Overfishing == "yes" & RHL > lowerCI & Bpresent > Bpast & Rpresent > Rpast){x <- initial}
if(BBMSY >= 1.5 & Overfishing == "yes" & RHL > lowerCI & Bpresent < Bpast){x <- restrictive}
#RHL exceeded
...
#BIOMASS IS HIGH 
    ...
    #Overfishing not occurring
if(BBMSY >= 1 & BBMSY < 1.5 & Overfishing == "no" & Bpresent > Bpast & Rpresent > Rpast){x <- liberal}
if(BBMSY >= 1 & BBMSY < 1.5 & Overfishing == "no" & Bpresent > Bpast & Rpresent < Rpast){x <- liberal}
if(BBMSY >= 1 & BBMSY < 1.5 & Overfishing == "no" & Bpresent < Bpast & Rpresent > Rpast){x <- initial}
if(BBMSY >= 1 & BBMSY < 1.5 & Overfishing == "no" & Bpresent < Bpast & Rpresent < Rpast){x <- initial}

    #Overfishing is occurring 
#RHL not exceeded
if(BBMSY >= 1 & BBMSY < 1.5 & Overfishing == "yes" & RHL > lowerCI & Bpresent > Bpast & Rpresent > Rpast){x <- initial}
if(BBMSY >= 1 & BBMSY < 1.5 & Overfishing == "yes" & RHL > lowerCI & Bpresent < Bpast){x <- restrictive}
#RHL exceeded
...
#BIOMASS IS LOW
    ...
    #Overfishing not occurring
if(BBMSY < 1 & BBMSY >= 0.5 & Overfishing == "no" & Bpresent > Bpast & Rpresent > Rpast){x <- initial}
if(BBMSY < 1 & BBMSY >= 0.5 & Overfishing == "no" & Bpresent < Bpast){x <- restrictive}

    #Overfishing is occurring
#RHL not exceeded
if(BBMSY < 1 & BBMSY >= 0.5 & Overfishing == "yes" & RHL > lowerCI & Bpresent > Bpast & Rpresent > Rpast){x <- initial}
if(BBMSY < 1 & BBMSY >= 0.5 & Overfishing == "yes" & RHL > lowerCI & Bpresent < Bpast){x <- restrictive}
#RHL exceeded
...
if(BBMSY >= 1.5){x <- Bin1}
if(BBMSY < 1.5 & BBMSY >= 1 & Bpresent > Bpast){x <- Bin1}
if(BBMSY < 1.5 & BBMSY >= 1 & Bpresent <= Bpast){x <- Bin2}
if(BBMSY < 1 & BBMSY >= 0.5 & Bpresent > Bpast){x <- Bin3}
if(BBMSY < 1 & BBMSY >= 0.5 & Bpresent <= Bpast){x <- Bin4}
if(BBMSY < 0.5 & Bpresent > Bpast){x <- Bin5}
if(BBMSY < 0.5 & Bpresent <= Bpast){x <- Bin6}
...
if(Alternative == 1){
 #saveRDS(finaltable1, file = "PCA_BiologicallyInformed_CatchTable_NYRegs")
#PCA_BioInformed_CatchTable_NYRegs <- readRDS("PCA_BiologicallyInformed_CatchTable_NYRegs.rds")
}
if(Alternative == 2){
 #saveRDS(finaltable1, file = "BRP_BiologicallyInformed_CatchTable_NYRegs")
#BRP_BioInformed_CatchTable_NYRegs <- readRDS("BRP_BiologicallyInformed_CatchTable_NYRegs.rds")
}
if(Alternative == 3){
 #saveRDS(finaltable1, file = "BBM_BiologicallyInformed_CatchTable_NYRegs")
