...
if(Alternative == "scen1"){setwd("~/Desktop/FlounderMSE/RDMgam/storelengths/allOMscen_allstartSSB_newersinatra/sim_storelength_allOMscenBin7/scen11_20/sim1_10")}
if(Alternative == "scen1"){scendir = "~/Desktop/FlounderMSE/RDMgam/storelengths/allOMscen_allstartSSB_newersinatra/sim_storelength_allOMscenBin7/scen1_10/sim1_10/"}
...
for (x in 1:560){
  ...
  # SCEN 1_10 1:112
    ...
    dat_directory <- "~/Desktop/FlounderMSE/RDMgam/storelengths/allOMscen_allstartSSB_newersinatra/sim_storelength_allOMscenBin7"
    ...
    subset_files <- dat_files[basename(dat_files) %in% c("om-length2020.dat", "om-length2021.dat","om-length2022.dat","om-length2023.dat","om-length2024.dat",
                                                         ...
                                                         "om-length2045.dat")] 
    #randomly sample a length structure
...
#saveRDS(RDMoutputbind_edit, "~/Desktop/FlounderMSE/RDMgam/RDMoutputbind_allOM_03BBMSY_2.rds") #trial 1 <- use this

############################# FIT MODEL ########################################
library(mgcv)
library(gratia)

#RDMoutputbind_edit <- readRDS("~/Desktop/FlounderMSE/RDMgam/RDMoutputbind_allOM_03BBMSY_1.rds") #trial 1 <- use this 
#RDMoutputbind_edit <- readRDS("~/Desktop/FlounderMSE/RDMgam/RDMoutputbind_allOM_03BBMSY_2.rds") 
...
#saveRDS(g1.1, "~/Desktop/FlounderMSE/RDMgam/gam_RDMland_allOM_03BBMSY_1.rds") #disordered length
#saveRDS(g1.1, "~/Desktop/FlounderMSE/RDMgam/gam_RDMland_allOM_03BBMSY_2.rds") #disordered length
#g1.1 <- readRDS("~/Desktop/FlounderMSE/RDMgam/gam_RDMland_allOM_03BBMSY_1.rds")
#g1.1 <- readRDS("~/Desktop/FlounderMSE/RDMgam/gam_RDMland_allOM_03BBMSY_2.rds")
summary(g1.1)
draw(g1.1)
appraise(g1.1)
...
#saveRDS(g1.1state, "~/Desktop/FlounderMSE/RDMgam/gam_RDMland_allOM_03BBMSY_1_state.rds")
#g1.1state <- readRDS("~/Desktop/FlounderMSE/RDMgam/gam_RDMland_allOM_03BBMSY_1_state.rds")
summary(g1.1state)
draw(g1.1state)
appraise(g1.1state)
