...
# Randomly samples from set of length distribution for each RDM run 
...
for (x in 1:315){
  ...
  Nlen <- 42 
  Nlengthbin1 <- scan("~/Desktop/FlounderMSE/kw_sims_test/sinatra_split_saveOM/RDMinputAttempt1/sim_storelength/om-length2020.dat",n=Nlen+1) #28781.11
  Nlengthbin2 <- scan("~/Desktop/FlounderMSE/kw_sims_test/sinatra_split_saveOM/RDMinputAttempt1/sim_storelength/om-length2021.dat",n=Nlen+1) #42332.81
  Nlengthbin3 <- scan("~/Desktop/FlounderMSE/kw_sims_test/sinatra_split_saveOM/RDMinputAttempt1/sim_storelength/om-length2022.dat",n=Nlen+1) #56688.65
  Nlengthbin4 <- scan("~/Desktop/FlounderMSE/kw_sims_test/sinatra_split_saveOM/RDMinputAttempt1/sim_storelength/om-length2039.dat",n=Nlen+1) #61616.96
  Nlengthbin5 <- scan("~/Desktop/FlounderMSE/kw_sims_test/sinatra_split_saveOM/RDMinputAttempt1/sim_storelength/om-length2024.dat",n=Nlen+1)  #76233.42        
  Nlengthbin6 <- scan("~/Desktop/FlounderMSE/kw_sims_test/sinatra_split_saveOM/RDMinputAttempt1/sim_storelength/om-length2027.dat",n=Nlen+1) #86364.19
  Nlengthbin7 <- scan("~/Desktop/FlounderMSE/kw_sims_test/sinatra_split_saveOM/RDMinputAttempt1/sim_storelength/om-length2045.dat",n=Nlen+1) #92265.6 
  Nlengthbin8 <- scan("~/Desktop/FlounderMSE/kw_sims_test/sinatra_split_saveOM/RDMinputAttempt1/sim_storelength_contrast/om-length2025.dat",n=Nlen+1) #101915.23 2025
  Nlengthbin9 <- scan("~/Desktop/FlounderMSE/kw_sims_test/sinatra_split_saveOM/RDMinputAttempt1/sim_storelength_contrast/om-length2025.dat",n=Nlen+1) #110281.24 2045
  Nlengthbin10 <- scan("~/Desktop/FlounderMSE/kw_sims_test/sinatra_split_saveOM/RDMinputAttempt1/sim_storelength_contrast/om-length2025.dat",n=Nlen+1) #152473.71 2037 
  Nlengthbin11 <- scan("~/Desktop/FlounderMSE/kw_sims_test/sinatra_split_saveOM/RDMinputAttempt1/sim_storelength_contrast/om-length2032.dat",n=Nlen+1) #167042.76 2032
  Nlengthbin12 <- scan("~/Desktop/FlounderMSE/kw_sims_test/sinatra_split_saveOM/RDMinputAttempt1/sim_storelength_contrast/om-length2026.dat",n=Nlen+1) #181257.26 2026  
  Nlengthbin13 <- scan("~/Desktop/FlounderMSE/kw_sims_test/sinatra_split_saveOM/RDMinputAttempt1/sim_storelength_contrast/om-length2027.dat",n=Nlen+1) #210394.15 2027
  Nlengthbin14 <- scan("~/Desktop/FlounderMSE/kw_sims_test/sinatra_split_saveOM/RDMinputAttempt1/sim_storelength_contrast/om-length2028.dat",n=Nlen+1) #225460.28 2028 
  Nlengthbin15 <- scan("~/Desktop/FlounderMSE/kw_sims_test/sinatra_split_saveOM/RDMinputAttempt1/sim_storelength_contrast/om-length2034.dat",n=Nlen+1) #254612.89 2034
  
  length_list <- list(Nlengthbin1, Nlengthbin2, Nlengthbin3, Nlengthbin4, Nlengthbin5, Nlengthbin6,
                      Nlengthbin7, Nlengthbin8, Nlengthbin9, Nlengthbin10, Nlengthbin11, Nlengthbin12, 
                      Nlengthbin13, Nlengthbin14, Nlengthbin15)
  om_length_cm <- sample(length_list, 1)
  om_length_cm <- as.vector(om_length_cm[[1]])
...
saveRDS(RDMoutputbind_edit, "~/Desktop/FlounderMSE/kw_sims_test/sinatra_split_saveOM/RDMoutputbind_rand.rds") #random length

############################# FIT MODEL ########################################
library(mgcv)
library(gratia)
RDMoutputbind_edit <- readRDS("~/Desktop/FlounderMSE/kw_sims_test/sinatra_split_saveOM/RDMoutputbind_rand.rds")
...
#Gamma w/ smooth 
g1 <- gam(tot_keep ~ state + s(SeasonLen, k = 3) + 
...
#Gamma GLM  
g2 <- gam(tot_keep ~ state + SeasonLen + 
...
#Poisson GLM
g3 <- gam(as.integer(tot_keep) ~ state + SeasonLen + 
            Bag + MinLen, data = inputdata, 
          family = poisson(link = log), method = "REML") 
gam.check(g3)

#Poisson w/ smooth
g4 <- gam(as.integer(tot_keep) ~ state + s(SeasonLen, k = 3) + 
            s(Bag, k = 3) + s(MinLen, k=3), data = inputdata, 
          family = poisson(link = log), method = "REML") 
gam.check(g4)
