...
#saveRDS(startbbmsydata_hcr, "~/Desktop/FlounderMSE/median_metrics_rdsfiles/version3_final/startbbmsydata_hcr.rds")
#saveRDS(startbbmsydata_reg, "~/Desktop/FlounderMSE/median_metrics_rdsfiles/version3_final/startbbmsydata_reg.rds")
```
...
p2 <- metrics2 %>% 
 ...
 #  coord_cartesian(ylim = c(min(metrics2$ymin), max(metrics2$ymax))) + 
  ...
  guides(fill = guide_legend(nrow = 1))
# add table summaries
#ggsave("~/Desktop/FlounderMSE/ManuscriptPrep/Draft5Figures_final/boxplot-metrics1bmsy.png",p2,width=9,height=6)
#ggsave("~/Desktop/FlounderMSE/ManuscriptPrep/Draft5Figures_final/boxplot-metrics2bmsy.png",p2,width=9,height=6)
#ggsave("~/Desktop/FlounderMSE/ManuscriptPrep/Draft5Figures_final/boxplot-metrics03bmsy.png",p2,width=9,height=6)
p2
```
...
#ggsave("~/Desktop/FlounderMSE/ManuscriptPrep/Draft5Figures_final/projectionplot2.png",final_projection_plot,width=9,height=6)
```
...
baglimit_all
#ggsave("~/Desktop/FlounderMSE/ManuscriptPrep/Draft5Figures_final/goodbad_baglimit_all.png",baglimit_all,width=9,height=7)
...
minlen_all <- ggplot(performancemetrics, aes(x = performance, y = minlen_value, fill = factor(mp2))) +
  ...
  scale_fill_manual(values = c("Biomass Matrix" = "#1b9e77", "Biological Ref. Point" = "#d95f02",
                               "No Change (RHL as target)" = "#7570b3", "Percent Change Approach" = "#e7298a"))
minlen_all
#ggsave("~/Desktop/FlounderMSE/ManuscriptPrep/Draft5Figures_final/goodbad_minlen_all.png",minlen_all,width=9,height=7)
...
seaslen_all <- ggplot(performancemetrics, aes(x = performance, y = seas_value, fill = factor(mp2))) +
  ...
  scale_x_discrete(
   ...
   scale_fill_manual(values = c("Biomass Matrix" = "#1b9e77", "Biological Ref. Point" = "#d95f02",
                               "No Change (RHL as target)" = "#7570b3", "Percent Change Approach" = "#e7298a"))
seaslen_all
#ggsave("~/Desktop/FlounderMSE/ManuscriptPrep/Draft5Figures_final/goodbad_seaslen_all.png",seaslen_all,width=9,height=7)
...
baglimit_bag <- ggplot(performancemetrics_bag, aes(x = performance, y = bag_value, fill = factor(mp2))) +
  ...
  scale_fill_manual(values = c("Biomass Matrix" = "#1b9e77", "Biological Ref. Point" = "#d95f02",
                               "No Change (RHL as target)" = "#7570b3", "Percent Change Approach" = "#e7298a"))
baglimit_bag
#ggsave("~/Desktop/FlounderMSE/ManuscriptPrep/Draft5Figures_final/goodbad_baglimit_bag.png",baglimit_bag,width=9,height=7)
...
minlen_min <- ggplot(performancemetrics_minlen, aes(x = performance, y = minlen_value, fill = factor(mp2))) +
  ...
  scale_fill_manual(values = c("Biomass Matrix" = "#1b9e77", "Biological Ref. Point" = "#d95f02",
                               "No Change (RHL as target)" = "#7570b3", "Percent Change Approach" = "#e7298a"))
minlen_min
#ggsave("~/Desktop/FlounderMSE/ManuscriptPrep/Draft5Figures_final/goodbad_minlen_min.png",minlen_min,width=9,height=7)
...
seaslen_seas <- ggplot(performancemetrics_seaslen, aes(x = performance, y = seaslen_value, fill = factor(mp2))) +
  ...
  scale_fill_manual(values = c("Biomass Matrix" = "#1b9e77", "Biological Ref. Point" = "#d95f02",
                               "No Change (RHL as target)" = "#7570b3", "Percent Change Approach" = "#e7298a"))
seaslen_seas
#ggsave("~/Desktop/FlounderMSE/ManuscriptPrep/Draft5Figures_final/goodbad_seaslen_seas.png",seaslen_seas,width=9,height=7)
...
median_metrics22 <- readRDS("~/Desktop/FlounderMSE/median_metrics_rdsfiles/version3_final/startbbmsydata_hcr.rds")
...
bmsy_hcr
#ggsave("~/Desktop/FlounderMSE/ManuscriptPrep/Draft5Figures_final/bmsy_hcr.png",bmsy_hcr,width=9,height=5.5)
...
median_metrics22 <- readRDS("~/Desktop/FlounderMSE/median_metrics_rdsfiles/version3_final/startbbmsydata_reg.rds")
...
#ggsave("~/Desktop/FlounderMSE/ManuscriptPrep/Draft5Figures_final/bmsy_reg.png",bmsy_reg,width=9,height=5.5)
