...
0.45
# Mgmt type (-1 = fixed regs, 1 = RHL, 2= F-based, 3 = RHL_risk, 4= F_risk, 6 = percent_change_RHL, 7 = percent_change_ACL [not coded], 8 = bioref_RHL, 9 = bioref_ACL [not coded], 10 = biomatrix_RHL)
-1
